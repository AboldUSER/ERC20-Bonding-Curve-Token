...
contract BondingBoldToken is BondingCurve, Ownable, ERC20 {
    ...
    event ContinuousMint(address _To, uint256 _amountMinted, uint256 _amountDeposited);

    event ContinuousBurn(address _To, uint256 _amountMinted, uint256 _amountDeposited);

    constructor(uint256 _reserveRatio) ERC20("BondingBoldToken", "BOLD") { 
    ...
    function calculateContinuousBurnReturn(uint256 _amount)
        internal view returns (uint256 burnAmount)
    {
